        ...
        while (true) {
            ...
            if (!wasError && this.isTrackable(operation)) {
                ...
                switch (operation.type) {
                    case MAKEDIR:
                        vcs.addToStage('\t' + "Created directory " + operation.getOperationArgs().get(1));
                        break;
                    case TOUCH:
                        vcs.addToStage('\t' + "Created file " + operation.getOperationArgs().get(1));
                        break;
                    case WRITETOFILE:
                        vcs.addToStage('\t' + "Added \"" + operation.getOperationArgs().get(1) + "\" to file "
